...
public class TestClass extends Pojo{
	...
	@BeforeTest
	@Parameters("browser")
	public void launchBrowser( @Optional String browser) throws Exception {
	...
	public void loginToUserAccount() {
		...
		kiteZerodhaLoginPage.sendKiteLoginPageUsername("LJ7056");
		kiteZerodhaLoginPage.sendKiteLoginPagePassword("suresh161996@");
		kiteZerodhaLoginPage.clickKiteLoginPageLogin();
		kiteZerodhaLoginPage.sendKiteLoginPagePin("950322");
